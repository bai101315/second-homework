...
checkmix=tk.Radiobutton(root,text="有括号",variable=var, value=4,
                ).place(x=400,y=180)

Lab3=Label(root,text='是否有小数').place(x=300,y=210)
var1 = tk.IntVar()
checkis=tk.Radiobutton(root,text="是",variable=var1, value=1,
                ).place(x=400,y=210)
checkno=tk.Radiobutton(root,text="否",variable=var1, value=0,
                ).place(x=450,y=210)
